	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float smoothstepResult17 = smoothstep( _DissolveTeam , ( _DissolveTeam + _DissolveSmoothness ) , (0.0 + (( tex2D( _Dissolve, uv_Dissolve ).r + IN.ase_texcoord8.xyz.x ) - _DissolveMin) * (1.0 - 0.0) / (_DissolveMax - _DissolveMin)));
				float4 lerpResult18 = lerp( ( _ColorTeam0 * tex2D( _AlbedoTeam0, uv_AlbedoTeam0 ) ) , ( tex2D( _AlbedoTeam1, uv_AlbedoTeam1 ) * _ColorTeam1 ) , ( 1.0 - smoothstepResult17 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float smoothstepResult17 = smoothstep( _DissolveTeam , ( _DissolveTeam + _DissolveSmoothness ) , (0.0 + (( tex2D( _Dissolve, uv_Dissolve ).r + IN.ase_texcoord1.xyz.x ) - _DissolveMin) * (1.0 - 0.0) / (_DissolveMax - _DissolveMin)));
				float4 lerpResult18 = lerp( ( _ColorTeam0 * tex2D( _AlbedoTeam0, uv_AlbedoTeam0 ) ) , ( tex2D( _AlbedoTeam1, uv_AlbedoTeam1 ) * _ColorTeam1 ) , ( 1.0 - smoothstepResult17 ));
...
/*ASEBEGIN
Version=17700
2567;-7;2546;1371;2272.119;668.3893;1;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;44;-1672.733,-291.0927;Inherit;True;Property;_Dissolve;Dissolve;8;0;Create;True;0;0;False;0;None;None;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.PosVertexDataNode;57;-1455.241,-139.5488;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;46;-927.4653,68.8468;Inherit;False;Property;_DissolveSmoothness;DissolveSmoothness;12;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-974.266,-14.99334;Inherit;False;Property;_DissolveTeam;DissolveTeam;11;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-1177.205,-132.4849;Inherit;False;Property;_DissolveMin;DissolveMin;9;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;36;-1177.205,-58.48486;Inherit;False;Property;_DissolveMax;DissolveMax;10;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;47;-628.4653,25.8468;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;17;-450.1118,-120.0118;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;5;-1071.368,-719.6932;Inherit;True;Property;_AlbedoTeam0;AlbedoTeam0;0;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;11;-776.0675,-409.6932;Inherit;False;Property;_ColorTeam1;ColorTeam1;3;1;[HDR];Create;True;0;0;False;0;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;16;-1072.498,-514.5824;Inherit;True;Property;_AlbedoTeam1;AlbedoTeam1;2;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;10;-885.6675,-867.0935;Inherit;False;Property;_ColorTeam0;ColorTeam0;1;1;[HDR];Create;True;0;0;False;0;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-374.4978,-556.5824;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;49;-190.7822,-164.4167;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-1203.681,254.3719;Inherit;False;Property;_NormalScale;NormalScale;5;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-391.7822,214.0715;Inherit;False;Property;_Smoothness;Smoothness;7;0;Create;True;0;0;False;0;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-396.9821,135.3717;Inherit;False;Property;_Metallic;Metallic;6;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;18;-32.4978,-249.5824;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=FE599105E775297A16C1A1DA14937A7D9ACFD54D